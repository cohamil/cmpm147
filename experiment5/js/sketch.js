...
function preload() {
  ...
  dropper2.onchange = e => shapeChanged(e.target.value);
}

function shapeChanged(newShape) {
  // change the current shape and trigger the restart button
